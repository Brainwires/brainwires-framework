...
brainwires-agent-network = { version = "0.5", features = ["full"] }

# Just TCP and pub/sub
brainwires-agent-network = { version = "0.5", features = ["tcp-transport", "pubsub-transport"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.5", features = ["agent-network"] }
```
