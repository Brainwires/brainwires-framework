...
[dependencies]
brainwires-audio = { version = "0.5", default-features = false }

# Default + local Whisper STT
[dependencies]
brainwires-audio = { version = "0.5", features = ["local-stt"] }

# FLAC only, no hardware
[dependencies]
brainwires-audio = { version = "0.5", default-features = false, features = ["flac"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.5", features = ["audio"] }
```
