...
//!
//! ```rust
//! use brainwires_model_tools::{is_injection_attempt, sanitize_external_content, wrap_with_content_source, filter_tool_output};
            ...
            .filter_map(|(pattern, label)| {
                match Regex::new(pattern) {
                    ...
                    Err(e) => {
                        ...
                        eprintln!("brainwires-model-tools: failed to compile sensitive pattern '{}': {}", pattern, e);
                        None
                    }
                }
            })
