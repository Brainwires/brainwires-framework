...
[dependencies]
brainwires-training = { version = "0.2", default-features = false, features = ["local"] }

# Full — cloud + local
[dependencies]
brainwires-training = { version = "0.2", features = ["full"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.2", features = ["training"] }
```
