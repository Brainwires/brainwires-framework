...
[dependencies]
brainwires-training = { version = "0.8", default-features = false, features = ["local"] }

# Full — cloud + local
[dependencies]
brainwires-training = { version = "0.8", features = ["full"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.8", features = ["training"] }
```
