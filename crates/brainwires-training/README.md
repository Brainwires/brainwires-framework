...
[dependencies]
brainwires-training = { version = "0.3", default-features = false, features = ["local"] }

# Full — cloud + local
[dependencies]
brainwires-training = { version = "0.3", features = ["full"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.3", features = ["training"] }
```
