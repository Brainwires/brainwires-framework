...
//!
//! This example demonstrates how to use brainwires-rag as a library to:
...
use brainwires_rag::{IndexRequest, QueryRequest, RagClient};
use std::env;
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("=== Brainwires RAG - Basic Indexing Example ===\n");
