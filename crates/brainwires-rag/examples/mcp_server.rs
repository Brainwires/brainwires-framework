...
use brainwires_rag::{mcp_server::RagMcpServer, Config, RagClient};
use std::sync::Arc;
...
async fn main() -> anyhow::Result<()> {
    ...
    println!("=== Brainwires RAG - MCP Server Example ===");
    println!();
    ...
    println!("  cargo run -p brainwires-rag --release");
    println!("Or:");
    println!("  ./target/release/brainwires-rag");
    println!();
