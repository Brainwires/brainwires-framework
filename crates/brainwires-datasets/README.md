...
[dependencies]
brainwires-datasets = { version = "0.3", features = ["tiktoken"] }

# Full feature set
[dependencies]
brainwires-datasets = { version = "0.3", features = ["full"] }

# Minimal — no tokenizer, just I/O and format conversion
[dependencies]
brainwires-datasets = { version = "0.3", default-features = false }
```
...
```toml
[dependencies]
brainwires = { version = "0.3", features = ["datasets"] }
```
