...
[![Tests](https://img.shields.io/badge/tests-64%20passing-brightgreen)](https://github.com/anthropics/brainwires-tool-orchestrator)
[![Coverage](https://img.shields.io/badge/coverage-92.59%25-brightgreen)](https://github.com/anthropics/brainwires-tool-orchestrator)
...
```bash
# Add to Cargo.toml
cargo add brainwires-tool-orchestrator
...
```typescript
import init, { WasmOrchestrator, ExecutionLimits } from 'brainwires-tool-orchestrator';
