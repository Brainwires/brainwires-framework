...
brainwires-wasm = { version = "0.7", features = ["interpreters"] }

# With tool orchestration
brainwires-wasm = { version = "0.7", features = ["orchestrator"] }

# Everything enabled
brainwires-wasm = { version = "0.7", features = ["interpreters", "orchestrator"] }
```
...
# Via facade
[dependencies]
brainwires = { version = "0.7", features = ["wasm"] }
