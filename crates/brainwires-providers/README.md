...
brainwires-providers = { version = "0.8", features = ["llama-cpp-2"] }

# Local LLM only (no cloud providers)
brainwires-providers = { version = "0.8", default-features = false, features = ["llama-cpp-2"] }
```
...
# Via facade
[dependencies]
brainwires = { version = "0.8", features = ["providers"] }
