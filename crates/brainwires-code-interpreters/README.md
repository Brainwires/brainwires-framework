...
```toml
[dependencies]
brainwires-code-interpreters = "0.5"
```
...
# All languages
brainwires-code-interpreters = { version = "0.5", features = ["all-languages"] }

# WASM target
brainwires-code-interpreters = { version = "0.5", default-features = false, features = ["wasm", "rhai", "lua"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.5", features = ["interpreter-all"] }
```
