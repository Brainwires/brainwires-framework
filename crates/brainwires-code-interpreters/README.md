...
# All languages
brainwires-code-interpreters = { version = "0.1", features = ["all-languages"] }

# WASM target
brainwires-code-interpreters = { version = "0.1", default-features = false, features = ["wasm", "rhai", "lua"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.1", features = ["interpreter-all"] }
```
