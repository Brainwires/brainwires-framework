...
```toml
# Pick what you need
brainwires-proxy = { version = "0.3", features = ["websocket", "inspector-api"] }

# Or enable everything
brainwires-proxy = { version = "0.3", features = ["full"] }
```
...
```toml
[dependencies]
brainwires = { version = "0.3", features = ["proxy"] }
```
