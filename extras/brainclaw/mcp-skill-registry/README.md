...
Use the `RegistryClient` from `brainwires-agents::skills` (formerly the standalone `brainwires-skills` crate, absorbed in the 0.10 consolidation):

```rust
use brainwires_agents::skills::{RegistryClient, SkillPackage, SkillManifest};
