...
Conversational AI via WebRTC protocol.

Scan for very large source files, and refacrtor.

Face - Web RTC UI to an AI Agent presented as a video feed. The agent can manipulate the video feed to show different things, use it as HUD, or even use it as a window into a virtual world for the agent.

Status of code execution abilities.
