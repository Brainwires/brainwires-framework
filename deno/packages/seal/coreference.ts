...
export class CoreferenceResolver {
  ...
  constructor() {
    ...
    this.definiteNpPatterns = [
      {
        regex: RE_THE_FILE,
        makeRef: () => ({ kind: "definite_np", entity_type: "file" }),
      },
      {
        regex: RE_THE_FUNCTION,
        makeRef: () => ({ kind: "definite_np", entity_type: "function" }),
      },
      {
        regex: RE_THE_TYPE,
        makeRef: () => ({ kind: "definite_np", entity_type: "type" }),
      },
      {
        regex: RE_THE_ERROR,
        makeRef: () => ({ kind: "definite_np", entity_type: "error" }),
      },
      {
        regex: RE_THE_VARIABLE,
        makeRef: () => ({ kind: "definite_np", entity_type: "variable" }),
      },
      {
        regex: RE_THE_COMMAND,
        makeRef: () => ({ kind: "definite_np", entity_type: "command" }),
      },
    ];
    ...
    this.demonstrativePatterns = [
      {
        regex: RE_DEMO_FILE,
        makeRef: () => ({ kind: "demonstrative", entity_type: "file" }),
      },
      {
        regex: RE_DEMO_FUNCTION,
        makeRef: () => ({ kind: "demonstrative", entity_type: "function" }),
      },
      {
        regex: RE_DEMO_TYPE,
        makeRef: () => ({ kind: "demonstrative", entity_type: "type" }),
      },
      {
        regex: RE_DEMO_ERROR,
        makeRef: () => ({ kind: "demonstrative", entity_type: "error" }),
      },
    ];
  }
  ...
  private resolveSingle(
    ...
    candidates.sort((a, b) =>
      salienceTotal(b.salience) - salienceTotal(a.salience)
    );
