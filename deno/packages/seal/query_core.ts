...
export class QueryCoreExtractor {
  ...
  extract(
    ...
    switch (question_type) {
      ...
      case "superlative": {
        const direction: SuperlativeDir = queryLower.includes("most") ||
